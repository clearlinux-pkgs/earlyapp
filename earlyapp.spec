...
Version  : 1.0.7
Release  : 9
URL      : https://github.com/intel/earlyapp/archive/v1.0.7.tar.gz
Source0  : https://github.com/intel/earlyapp/archive/v1.0.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550134138
mkdir -p clr-build
pushd clr-build
%cmake ..
