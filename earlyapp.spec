...
Version  : 0.90.14
Release  : 3
URL      : https://github.com/intel/earlyapp/archive/v0.90.14.tar.gz
Source0  : https://github.com/intel/earlyapp/archive/v0.90.14.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1542070061
mkdir -p clr-build
pushd clr-build
%cmake ..
