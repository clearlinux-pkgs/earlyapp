...
Source0  : https://github.com/intel/earlyapp/archive/v1.0.6.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548292284
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib/systemd/system/earlyapp-setup.service
