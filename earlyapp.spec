...
Source0  : https://github.com/intel/earlyapp/archive/v1.0.19.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552044502
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/share/earlyapp/early_ipu.sh
...
/usr/share/earlyapp/resume_sync
...
/usr/lib/systemd/system/earlyapp-setup-resume.service
