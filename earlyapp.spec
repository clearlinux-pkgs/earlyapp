...
Source0  : https://github.com/intel/earlyapp/archive/v1.0.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548135969
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files services
%defattr(-,root,root,-)
/usr/lib/systemd/system/earlyapp-setup-audio.service
