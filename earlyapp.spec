...
Version  : 1.0.13
Release  : 16
URL      : https://github.com/intel/earlyapp/archive/v1.0.13.tar.gz
Source0  : https://github.com/intel/earlyapp/archive/v1.0.13.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1551348714
mkdir -p clr-build
pushd clr-build
%cmake ..
